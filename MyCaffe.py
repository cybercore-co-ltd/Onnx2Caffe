...
def param_name_dict():
    ...
    # manual add permute operator
    param_names.append('permute')
    param_type_names.append('Permute')
...
class Function(object):
    ...
    def _to_proto(self):
        ...
        # manual adding operator Permute

        if 'Permute' in layer.type:
            import pdb; pdb.set_trace()
            setattr(layer,'permute_param', dict(order=1))
            # layer.param.append(dict(permute_param=dict(operator=[0,1,2,3])))
